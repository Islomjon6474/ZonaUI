  ...
  return (
    <JobWrapper>
      <div className="w-screen px-4 lg:px-48 pt-32 pb-20 cont bg-black">
        <div className="w-screen flex mb-20 items-center justify-start">
      ...
      <div className="w-screen flex lg:flex-nowrap flex-wrap  lg:px-36  pt-10 pb-20">
        <div className="flex xs:w-full flex-wrap break-all lg:w-8/12">
          <h1 className="text-dark text-2xl mt-6 mb-4 h1">Job Description</h1>
          <p className="f break-normal">
          ...
          <div className="flex flex-col">
            ...
            <div className="buttonsmuted flex flex-wrap items-center justify-content h-8">
              <IconButton
                aria-label="add to shopping cart"
        ...
        <div className="flex  h-fit gap-2 sm:w-full flex-wrap  sm:flex-col md:w-full ml-16 sm:ml-4 md:ml-2 lg:w-4/12   ">
